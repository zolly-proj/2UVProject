...
public:
    ...
    clEditObjectUI::clEditObjectUI(clIceClientServer * paIceClientServer, clIceClientLogging * paIceClientLogging, vector <clDatabaseColumn> paDatabaseColumns, vector <std::string> paValues, QWidget* paParent = 0, const char* paName = 0);
    ~clEditObjectUI ();
