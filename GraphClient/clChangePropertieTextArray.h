...
public:
    ...
    clChangePropertieTextArray::clChangePropertieTextArray(clIceClientServer * paIceClientServer, clIceClientLogging * paIceClientLogging, clDatabaseColumn paDatabaseColumn, QWidget* paParent = 0, const char* paName = 0);
