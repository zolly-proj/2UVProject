...
module UVServerAppServer {
    ...
    interface ServerAppServer
    {
      ...
      bool getFromTableDatabaseGeneralOrdered( string paTableName,
                                        string paStartValue,
                                        string paMaxValue,
					string paOrderBy,
                                        out tyStringSequence paReturnId,
      ...
      bool getFromTableDatbaseByProperty(   string paTableName,
                                            ...
                                            out tyStringSequence paReturnId,
                                            out string paReturnMessage);
      bool getFromTableDatbaseByPropertyOrdered(   string paTableName,
                                            string paStartValue,
                                            string paMaxValue,
                                            tyStringSequence paProperties,
                                            tyStringSequence paValue,
      ...
      bool giveWorkstationClientInfo(	string paWorkstationName,
                                        ...
                                        out string paReturnMessage);										
	  bool getServerFileStructure(	out string paFileStructure);
	  
	  bool getServerAppStructure(	out string paAppStructure);
    };
};
