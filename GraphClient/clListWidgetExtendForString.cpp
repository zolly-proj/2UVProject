...
void clListWidgetExtendForString::initializeElements()
{
    ...
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clListWidgetExtendForString::initializeElements" + QString(e.what()));
    }
}
...
void clListWidgetExtendForString::slotButtonDeletePressed()
{
    ...
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clListWidgetExtendForString::slotButtonDeletePressed() -> " + QString(e.what()));
    }
}
...
void clListWidgetExtendForString::slotButtonAddPressed()
{
    try
    {
		...
		if (loChangePropertieTextArray->exec() == 0)
        {
            ...
            meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe",QString("clListWidgetExtendForString::slotButtonAddPressed() -> " + loReturnMessage));
        }
        else
        {
			// Get and display the name of the computer.
            ...
            meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clListWidgetExtendForString::slotButtonAddPressed() -> insert canceled");
        }
    }
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clListWidgetExtendForString::slotButtonCancelPressed() -> " + QString(e.what()));
    }
}
