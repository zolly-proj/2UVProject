#ifndef CLDATABASEMYSQL_H_WVD_18052011
#define CLDATABASEMYSQL_H_WVD_18052011
...
public:
    clDatabaseMySql (QString paUserName, QString paPassword, QString paDatabaseName, QString paHostAdress, QString paPort);
    ~clDatabaseMySql ();
public:
