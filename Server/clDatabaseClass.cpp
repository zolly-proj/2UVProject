...
//Get From Database General ordered
bool clDatabaseClass::getFromTableDatabaseGeneralOrdered(QString paTableName,QString paStartValue, QString paMaxValue, QString paOrderBy, vector <QString> &paReturnId, vector <QString> &paReturnName, QString &paMessage)
{
    try
    {
        switch(getIDatabaseTech())
        {
            case 1:
                    return meDatabasePostgres->getFromTableDatabaseGeneralOrdered( paTableName, paStartValue, paMaxValue, paOrderBy, paReturnId, paReturnName, paMessage);
                    break;
            case 2:
                    //meDatabaseMySql = new clDatabaseMySql(getUserName(),getPassword(),getDataseName(),getHostAdress(),getPort());
                    break;
            case 3:
                    ...
                    break;
            default:
                    QString loTemp("bool clDatabaseClass::getFromTableDatabaseGeneralOrdered( paTableName, paStartValue, paMaxValue, paOrderBy, paReturnId, paReturnName, paMessage) -> Tech '" + getDatabaseTech() + "' not supported ...");
                    paMessage = loTemp;
                    return false;
                    break;
        }
    ...
    {
        QString loTemp("bool clDatabaseClass::getFromTableDatabaseGeneralOrdered( paTableName, paStartValue, paMaxValue, paOrderBy, paReturnId, paReturnName, paMessage) -> error ...");
        paMessage = loTemp;
        return false;
    }
}
...
//Get From Database by property
bool clDatabaseClass::getFromTableDatabaseByPropertyOrdered(QString paTableName, QString paStartValue, QString paMaxValue,vector <QString> paProperties,vector <QString> paValue, vector <QString> paTypeValue, vector <QString> paLogExp, QString paOrderBy, vector <QString> &paReturnId,QString &paMessage)
{
    try
    {
        switch(getIDatabaseTech())
        {
            case 1:
                    return meDatabasePostgres->getFromTableDatabaseByPropertyOrdered( paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, paReturnId, paMessage);
                    break;
            case 2:
                    //meDatabaseMySql = new clDatabaseMySql(getUserName(),getPassword(),getDataseName(),getHostAdress(),getPort());
                    break;
