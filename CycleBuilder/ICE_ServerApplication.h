...
public:
    ...
    /**
     * Encapsulates the results of a call to getFromTableDatabaseGeneralOrdered.
     */
    struct GetFromTableDatabaseGeneralOrderedResult
    {
        bool returnValue;
        tyStringSequence paReturnId;
        tyStringSequence paReturnName;
    ...
    virtual bool getFromTableDatabaseGeneralOrdered(::std::string paTableName, ::std::string paStartValue, ::std::string paMaxValue, ::std::string paOrderBy, tyStringSequence& paReturnId, tyStringSequence& paReturnName, ::std::string& paMessage, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getFromTableDatabaseGeneralOrdered(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    /**
     * Encapsulates the results of a call to getFromTableDatbaseByPropertyOrdered.
     */
    struct GetFromTableDatbaseByPropertyOrderedResult
    {
        bool returnValue;
        tyStringSequence paReturnId;
        ::std::string paReturnMessage;
    ...
    virtual bool getFromTableDatbaseByPropertyOrdered(::std::string paTableName, ::std::string paStartValue, ::std::string paMaxValue, tyStringSequence paProperties, tyStringSequence paValue, tyStringSequence paTypeValue, tyStringSequence paLogExp, ::std::string paOrderBy, tyStringSequence& paReturnId, ::std::string& paReturnMessage, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getFromTableDatbaseByPropertyOrdered(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    /**
     * Encapsulates the results of a call to getServerFileStructure.
     */
    struct GetServerFileStructureResult
    {
        bool returnValue;
        ::std::string paFileStructure;
    };

    virtual bool getServerFileStructure(::std::string& paFileStructure, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getServerFileStructure(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    /**
     * Encapsulates the results of a call to getServerAppStructure.
     */
    struct GetServerAppStructureResult
    {
        bool returnValue;
        ::std::string paAppStructure;
    };

    virtual bool getServerAppStructure(::std::string& paAppStructure, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getServerAppStructure(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    bool getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, tyStringSequence& paReturnId, tyStringSequence& paReturnName, ::std::string& paMessage, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<ServerAppServer::GetFromTableDatabaseGeneralOrderedResult>(true, this, &ServerAppServerPrx::_iceI_getFromTableDatabaseGeneralOrdered, paTableName, paStartValue, paMaxValue, paOrderBy, context).get();
        paReturnId = ::std::move(_result.paReturnId);
        paReturnName = ::std::move(_result.paReturnName);
        paMessage = ::std::move(_result.paMessage);
        return _result.returnValue;
    ...
    template<template<typename> class P = ::std::promise>
    auto getFromTableDatabaseGeneralOrderedAsync(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<ServerAppServer::GetFromTableDatabaseGeneralOrderedResult>>().get_future())
    {
        return _makePromiseOutgoing<ServerAppServer::GetFromTableDatabaseGeneralOrderedResult, P>(false, this, &ServerAppServerPrx::_iceI_getFromTableDatabaseGeneralOrdered, paTableName, paStartValue, paMaxValue, paOrderBy, context);
    }

    ::std::function<void()>
    getFromTableDatabaseGeneralOrderedAsync(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy,
                                            ::std::function<void(bool, ::UVServerAppServer::tyStringSequence, ::UVServerAppServer::tyStringSequence, ::std::string)> response,
                                            ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                            ::std::function<void(bool)> sent = nullptr,
                                            const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](ServerAppServer::GetFromTableDatabaseGeneralOrderedResult&& _result)
        {
            response(_result.returnValue, ::std::move(_result.paReturnId), ::std::move(_result.paReturnName), ::std::move(_result.paMessage));
        };
        return _makeLamdaOutgoing<ServerAppServer::GetFromTableDatabaseGeneralOrderedResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &UVServerAppServer::ServerAppServerPrx::_iceI_getFromTableDatabaseGeneralOrdered, paTableName, paStartValue, paMaxValue, paOrderBy, context);
    }

    /// \cond INTERNAL
    void _iceI_getFromTableDatabaseGeneralOrdered(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ServerAppServer::GetFromTableDatabaseGeneralOrderedResult>>&, const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::Ice::Context&);
    /// \endcond
    ...
    bool getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const tyStringSequence& paProperties, const tyStringSequence& paValue, const tyStringSequence& paTypeValue, const tyStringSequence& paLogExp, const ::std::string& paOrderBy, tyStringSequence& paReturnId, ::std::string& paReturnMessage, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult>(true, this, &ServerAppServerPrx::_iceI_getFromTableDatbaseByPropertyOrdered, paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context).get();
        paReturnId = ::std::move(_result.paReturnId);
        paReturnMessage = ::std::move(_result.paReturnMessage);
        return _result.returnValue;
    }
    ...
    template<template<typename> class P = ::std::promise>
    auto getFromTableDatbaseByPropertyOrderedAsync(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const tyStringSequence& paProperties, const tyStringSequence& paValue, const tyStringSequence& paTypeValue, const tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult>>().get_future())
    {
        return _makePromiseOutgoing<ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult, P>(false, this, &ServerAppServerPrx::_iceI_getFromTableDatbaseByPropertyOrdered, paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context);
    }

    ::std::function<void()>
    getFromTableDatbaseByPropertyOrderedAsync(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const tyStringSequence& paProperties, const tyStringSequence& paValue, const tyStringSequence& paTypeValue, const tyStringSequence& paLogExp, const ::std::string& paOrderBy,
                                              ::std::function<void(bool, ::UVServerAppServer::tyStringSequence, ::std::string)> response,
                                              ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                              ::std::function<void(bool)> sent = nullptr,
                                              const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult&& _result)
        {
            response(_result.returnValue, ::std::move(_result.paReturnId), ::std::move(_result.paReturnMessage));
        };
        return _makeLamdaOutgoing<ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &UVServerAppServer::ServerAppServerPrx::_iceI_getFromTableDatbaseByPropertyOrdered, paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context);
    }

    /// \cond INTERNAL
    void _iceI_getFromTableDatbaseByPropertyOrdered(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ServerAppServer::GetFromTableDatbaseByPropertyOrderedResult>>&, const ::std::string&, const ::std::string&, const ::std::string&, const tyStringSequence&, const tyStringSequence&, const tyStringSequence&, const tyStringSequence&, const ::std::string&, const ::Ice::Context&);
    /// \endcond
    ...
    bool getServerFileStructure(::std::string& paFileStructure, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<ServerAppServer::GetServerFileStructureResult>(true, this, &ServerAppServerPrx::_iceI_getServerFileStructure, context).get();
        paFileStructure = ::std::move(_result.paFileStructure);
        return _result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto getServerFileStructureAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<ServerAppServer::GetServerFileStructureResult>>().get_future())
    {
        return _makePromiseOutgoing<ServerAppServer::GetServerFileStructureResult, P>(false, this, &ServerAppServerPrx::_iceI_getServerFileStructure, context);
    }

    ::std::function<void()>
    getServerFileStructureAsync(::std::function<void(bool, ::std::string)> response,
                                ::std::function<void(::std::exception_ptr)> ex = nullptr,
                                ::std::function<void(bool)> sent = nullptr,
                                const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](ServerAppServer::GetServerFileStructureResult&& _result)
        {
            response(_result.returnValue, ::std::move(_result.paFileStructure));
        };
        return _makeLamdaOutgoing<ServerAppServer::GetServerFileStructureResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &UVServerAppServer::ServerAppServerPrx::_iceI_getServerFileStructure, context);
    }

    /// \cond INTERNAL
    void _iceI_getServerFileStructure(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ServerAppServer::GetServerFileStructureResult>>&, const ::Ice::Context&);
    /// \endcond

    bool getServerAppStructure(::std::string& paAppStructure, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _result = _makePromiseOutgoing<ServerAppServer::GetServerAppStructureResult>(true, this, &ServerAppServerPrx::_iceI_getServerAppStructure, context).get();
        paAppStructure = ::std::move(_result.paAppStructure);
        return _result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto getServerAppStructureAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<ServerAppServer::GetServerAppStructureResult>>().get_future())
    {
        return _makePromiseOutgoing<ServerAppServer::GetServerAppStructureResult, P>(false, this, &ServerAppServerPrx::_iceI_getServerAppStructure, context);
    }

    ::std::function<void()>
    getServerAppStructureAsync(::std::function<void(bool, ::std::string)> response,
                               ::std::function<void(::std::exception_ptr)> ex = nullptr,
                               ::std::function<void(bool)> sent = nullptr,
                               const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        auto _responseCb = [response](ServerAppServer::GetServerAppStructureResult&& _result)
        {
            response(_result.returnValue, ::std::move(_result.paAppStructure));
        };
        return _makeLamdaOutgoing<ServerAppServer::GetServerAppStructureResult>(std::move(_responseCb), std::move(ex), std::move(sent), this, &UVServerAppServer::ServerAppServerPrx::_iceI_getServerAppStructure, context);
    }

    /// \cond INTERNAL
    void _iceI_getServerAppStructure(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ServerAppServer::GetServerAppStructureResult>>&, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatabaseGeneralOrdered.
 * Create a wrapper instance by calling ::UVServerAppServer::newCallback_ServerAppServer_getFromTableDatabaseGeneralOrdered.
 */
class Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered_Base> Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr;
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatbaseByPropertyOrdered.
 * Create a wrapper instance by calling ::UVServerAppServer::newCallback_ServerAppServer_getFromTableDatbaseByPropertyOrdered.
 */
class Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered_Base> Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr;
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::UVServerAppServer::ServerAppServer::begin_getServerFileStructure.
 * Create a wrapper instance by calling ::UVServerAppServer::newCallback_ServerAppServer_getServerFileStructure.
 */
class Callback_ServerAppServer_getServerFileStructure_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_ServerAppServer_getServerFileStructure_Base> Callback_ServerAppServer_getServerFileStructurePtr;

/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::UVServerAppServer::ServerAppServer::begin_getServerAppStructure.
 * Create a wrapper instance by calling ::UVServerAppServer::newCallback_ServerAppServer_getServerAppStructure.
 */
class Callback_ServerAppServer_getServerAppStructure_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_ServerAppServer_getServerAppStructure_Base> Callback_ServerAppServer_getServerAppStructurePtr;
...
public:
    ...
    bool getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, ::UVServerAppServer::tyStringSequence& paReturnId, ::UVServerAppServer::tyStringSequence& paReturnName, ::std::string& paMessage, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getFromTableDatabaseGeneralOrdered(paReturnId, paReturnName, paMessage, _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::UVServerAppServer::Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, const ::Ice::Context& context, const ::UVServerAppServer::Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatabaseGeneralOrdered(paTableName, paStartValue, paMaxValue, paOrderBy, context, cb, cookie);
    }

    bool end_getFromTableDatabaseGeneralOrdered(::UVServerAppServer::tyStringSequence& paReturnId, ::UVServerAppServer::tyStringSequence& paReturnName, ::std::string& paMessage, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getFromTableDatabaseGeneralOrdered(::UVServerAppServer::tyStringSequence& iceP_paReturnId, ::UVServerAppServer::tyStringSequence& iceP_paReturnName, ::std::string& iceP_paMessage, bool& ret, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_getFromTableDatabaseGeneralOrdered(const ::std::string&, const ::std::string&, const ::std::string&, const ::std::string&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    bool getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, ::UVServerAppServer::tyStringSequence& paReturnId, ::std::string& paReturnMessage, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getFromTableDatbaseByPropertyOrdered(paReturnId, paReturnMessage, _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::UVServerAppServer::Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::UVServerAppServer::tyStringSequence& paProperties, const ::UVServerAppServer::tyStringSequence& paValue, const ::UVServerAppServer::tyStringSequence& paTypeValue, const ::UVServerAppServer::tyStringSequence& paLogExp, const ::std::string& paOrderBy, const ::Ice::Context& context, const ::UVServerAppServer::Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getFromTableDatbaseByPropertyOrdered(paTableName, paStartValue, paMaxValue, paProperties, paValue, paTypeValue, paLogExp, paOrderBy, context, cb, cookie);
    }

    bool end_getFromTableDatbaseByPropertyOrdered(::UVServerAppServer::tyStringSequence& paReturnId, ::std::string& paReturnMessage, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getFromTableDatbaseByPropertyOrdered(::UVServerAppServer::tyStringSequence& iceP_paReturnId, ::std::string& iceP_paReturnMessage, bool& ret, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_getFromTableDatbaseByPropertyOrdered(const ::std::string&, const ::std::string&, const ::std::string&, const ::UVServerAppServer::tyStringSequence&, const ::UVServerAppServer::tyStringSequence&, const ::UVServerAppServer::tyStringSequence&, const ::UVServerAppServer::tyStringSequence&, const ::std::string&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    bool getServerFileStructure(::std::string& paFileStructure, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getServerFileStructure(paFileStructure, _iceI_begin_getServerFileStructure(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getServerFileStructure(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getServerFileStructure(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getServerFileStructure(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerFileStructure(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerFileStructure(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerFileStructure(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerFileStructure(const ::UVServerAppServer::Callback_ServerAppServer_getServerFileStructurePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerFileStructure(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerFileStructure(const ::Ice::Context& context, const ::UVServerAppServer::Callback_ServerAppServer_getServerFileStructurePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerFileStructure(context, cb, cookie);
    }

    bool end_getServerFileStructure(::std::string& paFileStructure, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getServerFileStructure(::std::string& iceP_paFileStructure, bool& ret, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_getServerFileStructure(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);

public:

    bool getServerAppStructure(::std::string& paAppStructure, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getServerAppStructure(paAppStructure, _iceI_begin_getServerAppStructure(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getServerAppStructure(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getServerAppStructure(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getServerAppStructure(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerAppStructure(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerAppStructure(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerAppStructure(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerAppStructure(const ::UVServerAppServer::Callback_ServerAppServer_getServerAppStructurePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerAppStructure(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getServerAppStructure(const ::Ice::Context& context, const ::UVServerAppServer::Callback_ServerAppServer_getServerAppStructurePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getServerAppStructure(context, cb, cookie);
    }

    bool end_getServerAppStructure(::std::string& paAppStructure, const ::Ice::AsyncResultPtr& result);
    /// \cond INTERNAL

    void _iceI_end_getServerAppStructure(::std::string& iceP_paAppStructure, bool& ret, const ::Ice::AsyncResultPtr&);
    /// \endcond

private:

    ::Ice::AsyncResultPtr _iceI_begin_getServerAppStructure(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual bool getFromTableDatabaseGeneralOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const ::std::string& paOrderBy, tyStringSequence& paReturnId, tyStringSequence& paReturnName, ::std::string& paMessage, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getFromTableDatabaseGeneralOrdered(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    virtual bool getFromTableDatbaseByPropertyOrdered(const ::std::string& paTableName, const ::std::string& paStartValue, const ::std::string& paMaxValue, const tyStringSequence& paProperties, const tyStringSequence& paValue, const tyStringSequence& paTypeValue, const tyStringSequence& paLogExp, const ::std::string& paOrderBy, tyStringSequence& paReturnId, ::std::string& paReturnMessage, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getFromTableDatbaseByPropertyOrdered(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    virtual bool getServerFileStructure(::std::string& paFileStructure, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getServerFileStructure(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond

    virtual bool getServerAppStructure(::std::string& paAppStructure, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getServerAppStructure(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 */
template<class T>
class CallbackNC_ServerAppServer_getFromTableDatabaseGeneralOrdered : public Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_ServerAppServer_getFromTableDatabaseGeneralOrdered(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            ret = proxy->end_getFromTableDatabaseGeneralOrdered(iceP_paReturnId, iceP_paReturnName, iceP_paMessage, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatabaseGeneralOrdered.
 */
template<class T> Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr
newCallback_ServerAppServer_getFromTableDatabaseGeneralOrdered(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const tyStringSequence&, const tyStringSequence&, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getFromTableDatabaseGeneralOrdered<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr
newCallback_ServerAppServer_getFromTableDatabaseGeneralOrdered(T* instance, void (T::*cb)(bool, const tyStringSequence&, const tyStringSequence&, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getFromTableDatabaseGeneralOrdered<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered : public Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatabaseGeneralOrdered.
 */
template<class T, typename CT> Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr
newCallback_ServerAppServer_getFromTableDatabaseGeneralOrdered(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const tyStringSequence&, const tyStringSequence&, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_ServerAppServer_getFromTableDatabaseGeneralOrderedPtr
newCallback_ServerAppServer_getFromTableDatabaseGeneralOrdered(T* instance, void (T::*cb)(bool, const tyStringSequence&, const tyStringSequence&, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getFromTableDatabaseGeneralOrdered<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_ServerAppServer_getFromTableDatbaseByPropertyOrdered : public Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_ServerAppServer_getFromTableDatbaseByPropertyOrdered(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            ret = proxy->end_getFromTableDatbaseByPropertyOrdered(iceP_paReturnId, iceP_paReturnMessage, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatbaseByPropertyOrdered.
 */
template<class T> Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr
newCallback_ServerAppServer_getFromTableDatbaseByPropertyOrdered(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const tyStringSequence&, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getFromTableDatbaseByPropertyOrdered<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr
newCallback_ServerAppServer_getFromTableDatbaseByPropertyOrdered(T* instance, void (T::*cb)(bool, const tyStringSequence&, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getFromTableDatbaseByPropertyOrdered<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered : public Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getFromTableDatbaseByPropertyOrdered.
 */
template<class T, typename CT> Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr
newCallback_ServerAppServer_getFromTableDatbaseByPropertyOrdered(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const tyStringSequence&, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_ServerAppServer_getFromTableDatbaseByPropertyOrderedPtr
newCallback_ServerAppServer_getFromTableDatbaseByPropertyOrdered(T* instance, void (T::*cb)(bool, const tyStringSequence&, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getFromTableDatbaseByPropertyOrdered<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_ServerAppServer_getServerFileStructure : public Callback_ServerAppServer_getServerFileStructure_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_ServerAppServer_getServerFileStructure(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    {
        ServerAppServerPrx proxy = ServerAppServerPrx::uncheckedCast(result->getProxy());
        ::std::string iceP_paFileStructure;
        bool ret;
        try
        {
            ret = proxy->end_getServerFileStructure(iceP_paFileStructure, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(ret, iceP_paFileStructure);
        }
    }
    /// \endcond
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getServerFileStructure.
 */
template<class T> Callback_ServerAppServer_getServerFileStructurePtr
newCallback_ServerAppServer_getServerFileStructure(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getServerFileStructure<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_ServerAppServer_getServerFileStructurePtr
newCallback_ServerAppServer_getServerFileStructure(T* instance, void (T::*cb)(bool, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getServerFileStructure<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_ServerAppServer_getServerFileStructure : public Callback_ServerAppServer_getServerFileStructure_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_ServerAppServer_getServerFileStructure(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(ret, iceP_paFileStructure, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getServerFileStructure.
 */
template<class T, typename CT> Callback_ServerAppServer_getServerFileStructurePtr
newCallback_ServerAppServer_getServerFileStructure(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getServerFileStructure<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_ServerAppServer_getServerFileStructurePtr
newCallback_ServerAppServer_getServerFileStructure(T* instance, void (T::*cb)(bool, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getServerFileStructure<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T>
class CallbackNC_ServerAppServer_getServerAppStructure : public Callback_ServerAppServer_getServerAppStructure_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_ServerAppServer_getServerAppStructure(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    {
        ServerAppServerPrx proxy = ServerAppServerPrx::uncheckedCast(result->getProxy());
        ::std::string iceP_paAppStructure;
        bool ret;
        try
        {
            ret = proxy->end_getServerAppStructure(iceP_paAppStructure, result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
        ...
        if(_response)
        {
            (::IceInternal::CallbackNC<T>::_callback.get()->*_response)(ret, iceP_paAppStructure);
        }
    }
    /// \endcond
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getServerAppStructure.
 */
template<class T> Callback_ServerAppServer_getServerAppStructurePtr
newCallback_ServerAppServer_getServerAppStructure(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getServerAppStructure<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_ServerAppServer_getServerAppStructurePtr
newCallback_ServerAppServer_getServerAppStructure(T* instance, void (T::*cb)(bool, const ::std::string&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_ServerAppServer_getServerAppStructure<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_ServerAppServer_getServerAppStructure : public Callback_ServerAppServer_getServerAppStructure_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_ServerAppServer_getServerAppStructure(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        if(_response)
        {
            (::IceInternal::Callback<T, CT>::_callback.get()->*_response)(ret, iceP_paAppStructure, CT::dynamicCast(result->getCookie()));
        }
    }
    /// \endcond
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::UVServerAppServer::ServerAppServer::begin_getServerAppStructure.
 */
template<class T, typename CT> Callback_ServerAppServer_getServerAppStructurePtr
newCallback_ServerAppServer_getServerAppStructure(const IceUtil::Handle<T>& instance, void (T::*cb)(bool, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getServerAppStructure<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_ServerAppServer_getServerAppStructurePtr
newCallback_ServerAppServer_getServerAppStructure(T* instance, void (T::*cb)(bool, const ::std::string&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_ServerAppServer_getServerAppStructure<T, CT>(instance, cb, excb, sentcb);
}
