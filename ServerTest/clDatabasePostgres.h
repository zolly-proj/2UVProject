...
public:
    clDatabasePostgres (QString paUserName, QString paPassword, QString paDatabaseName, QString paHostAdress, QString paPort, vector<clDatabaseTable> paXMLDatabaseTable, vector<clDatabaseRoutine> paXMLDatabaseRoutine);
    ~clDatabasePostgres ();
public:
...
private:
    ...
    bool getColumnsString(QString paTableName, vector <QString> paColumns, QString &paResult);
