...
bool clIceClientServer::getFromTableDatabaseGeneralOrdered(   QString& paTableName,
                                            QString& paStartValue,
                                            QString& paMaxValue,
											QString& paOrderBy,
                                            vector<std::string>& paReturnId,
                                            ...
                                            QString& paReturnMessage)
{
    try
    {
        string loReturnMessage;
        loReturnMessage = std::string(paReturnMessage.toUtf8());
        meServerAppServer->getFromTableDatabaseGeneralOrdered(string(paTableName.toUtf8()), string(paStartValue.toUtf8()), string(paMaxValue.toUtf8()), string(paOrderBy.toUtf8()), paReturnId, paReturnName, loReturnMessage);
        paReturnMessage = QString(loReturnMessage.c_str());
        return true;
    }
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("10",QString(QHostInfo::localHostName()),"2UVServerTest.exe","clIceClientServer::getFromTableDatabaseGeneralOrdered -> " + QString(e.what()));
        return false;
    }
}
...
bool clIceClientServer::getFromTableDatbaseByPropertyOrdered(     QString& paTableName,
                                                QString& paStartValue,
                                                QString& paMaxValue,
                                                vector<std::string>& paProperties,
                                                vector<std::string>& paValue,
                                                ...
                                                QString& paReturnMessage)
{
    try
    {
        ...
        string loReturnMessage;
        loReturnMessage = std::string(paReturnMessage.toUtf8());
        meServerAppServer->getFromTableDatbaseByPropertyOrdered(string(paTableName.toUtf8()), string(paStartValue.toUtf8()), string(paMaxValue.toUtf8()), loProperties, loValue, loTypeValue, loLogExp, string(paOrderBy.toUtf8()), paReturnId, loReturnMessage);
    ...
    {
        meIceClientLogging->insertItem("10",QString(QHostInfo::localHostName()),"2UVServerTest.exe","clIceClientServer::getFromTableDatbaseByPropertyOrdered -> " + QString(e.what()));
        return false;
    }
}
