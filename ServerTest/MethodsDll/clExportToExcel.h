#ifndef _CLEXPORTTOEXCEL_H
#define _CLEXPORTTOEXCEL_H
...
class clExportToExcel : public clMethodCall
{
public:
    clExportToExcel ();
    ~clExportToExcel ();
...
private:
	...
	clExportToExcelUI *meExportToExcelUI;
};
#endif
extern "C" clMethodCall* CreateModule()
{
    // call the constructor of the actual implementation
    clMethodCall * module = new clExportToExcel();
