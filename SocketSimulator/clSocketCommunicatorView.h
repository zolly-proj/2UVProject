#ifndef CLSOCKETCOMMUNICATORVIEW_H
#define CLSOCKETCOMMUNICATORVIEW_H
...
class clSocketCommunicatorView : public QWidget
{
...
public:
    ...
    clSocketCommunicatorView (clIceClientServer * paIceClientServer, clIceClientLogging *paIceClientLogging, clClassLoader *paClassLoader, QString paConfigurationFile, QWidget* paParent = 0, const char* paName = 0); //, WFlags paFlags = 0);
    ~clSocketCommunicatorView ();

    Ui::wdSocketSimulatorUi meSocketCommunicatorUi;
