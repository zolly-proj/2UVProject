...
void clProductPlanner::slotButtonPlanPressed()
{
    try
    {
		...
		for (int i = 0; i < (int) meProductPlanner.tvwProductView->topLevelItemCount(); i++)
		{
			...
			for (int j = 0; j < (int) loObjectsWs.size(); j++)
			{
		...
		for (int i = 0; i < (int) meProductPlanner.tvwProductView->topLevelItemCount(); i++)
		{
			...
			for (int k = 0; k < (int) loObjectsGroup.size(); k++)
			{	
		...
		for (int i = 0; i < (int) loProducts.size(); i++)
		{
			...
			for (int j = 0; j < loProducts.at(i).meMachGroupUuid.size(); j++)
			{
				...
				for (int k = 0; k < loWorkplaces.size(); k++)
				{
					...
					for (int l = 0; l < (int) loWorkplaces.at(k).meMachGroupUUID.size();l++)
					{
			...
			for (int j = 0; j < (int) loProductWorkstepsMatchingWorkplaces.size(); j++)
			{
		...
		*/
        ...
        meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clProductPlanner::slotButtonPlanPressed()" + loMessage);
        meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clProductPlanner::slotButtonPlanPressed()" + loMessageTable);
		*/
...
void clProductPlanner::slotTreeClassItemPressed(QTreeWidgetItem *item, int index)
{
    try
    {
        ...
        if( item->parent() == NULL)
        {
            ...
            meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotTreeClassItemPressed -> " + loReturnMessage);
...
void clProductPlanner::slotCallMethod(const QString &paActionName)
{
    ...
    {
        meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clParameterView::slotCallMethod -> " + QString(e.what()));
    }	
}
void clProductPlanner::slotCallClassMethod(const QString &paActionName)
{
    ...
    {
        meIceClientLogging->insertItem("10",QString(infoBuf),"2UVServerTest.exe","clParameterView::slotCallClassMethod -> " + QString(e.what()));
    }	
}
void clObjectViewer::slotEditElement()
{
    try
    {
        ...
        QString loMessage;
		meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement()-> Table name=" + loItem->getClassName());		
		...
		meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement()-> Amount of properties=" + QString::number(loPropertyName.size()));
		...
		for (int i = 0; i < loPropertyName.size(); i++)
		{
			...
			{
				meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement()-> Propertie name [" + QString(loPropertyName[i].c_str()) + "]");				
		...
		meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement -> " + loReturnMessageGetById);
        ...
        if (loEditObjectUI->exec() == 0)
		{
            ...
            meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement() -> " + loReturnMessage);
        }
        else
        {
			// Get and display the name of the computer.
            ...
            meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement() -> update canceled");
        }
    ...
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::slotEditElement -> " + QString(e.what()));
    }	
        ...
        for (int i = 0; i < paTables.size();i++)
        {
			...
			else
			{
				...
				for (int k = 0; k < loReturnIds.size(); k++)
				{
					...
					QString loID = QString(loReturnIds.at(k).c_str());
...
bool clObjectViewer::addElementsToQTreeWidget(QTreeWidgetItem * paItem, vector<std::string> paReturnIds, vector<std::string> paReturnNames)
{
    ...
    catch(exception &e)
    {
        ...
        meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::addElementsToQTreeWidget -> " + QString(e.what()));
        return false;
    }
}
...
bool clObjectViewer::addElementToQTreeWidgetSub(QTreeWidgetItem * paParent, QString paID, QString paTable)
{
    ...
    try
    {
		...
		meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::addElementToQTreeWidgetSub -> " + loReturnMessageObject);
		...
		meIceClientServer->getFromTableDatabaseById(paTable,
													...
													loReturnValues,
													loReturnMessageGetById);
		meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::addElementToQTreeWidgetSub -> " + loReturnMessageGetById);
...
bool clObjectViewer::addElementsToQTreeWidgetSub(QTreeWidgetItem * paParent, QString paID, QString paTable)
{
    ...
    try
    {
        ...
        for (int i = 0; i< loElements.size();i++)
        {
			...
			meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::addElementsToQTreeWidgetSub -> " + loReturnMessageObject);
			...
			loGetID = meIceClientServer->getFromTableDatabaseById(paTable,
														...
														loReturnValues,
														loReturnMessageGetById);
			meIceClientLogging->insertItem("50",QString(infoBuf),"2UVObjectViewer.exe","clObjectViewer::addElementsToQTreeWidgetSub -> " + loReturnMessageGetById);
